...
global_variables() {
    global_software_name="bashblog-ng"
    global_software_version="1.0"

    # Blog title
    global_title="O Próprio Levi"
    # The typical subtitle for each blog
    global_description=""
    # The public base URL for this blog
    global_url="http://opropriolevi.github.io/"
...
google_analytics() {
    ...
    if [[ -z $global_analytics_file ]]; then
        ...
        <script async src=\"https://www.googletagmanager.com/gtag/js?id=${global_analytics}\"></script>
        <script>
