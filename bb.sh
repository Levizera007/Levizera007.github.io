...
global_variables() {
    ...
    # Blog title
    global_title="Levizera"
    # The typical subtitle for each blog
    global_description="Talvez apenas um arquivo de estudos pessoais"
    # The public base URL for this blog
    global_url="http://levizera007.github.io"

    # Your name
    global_author="Levizera"
    # You can use twitter or facebook or anything for global_author_url
    global_author_url="http://twitter.com/opropriolevi" 
    # Your email
    ...
    global_twitter_username="opropriolevi"
    ...
    template_read_more="Leia mais..."
    # "View more posts" (used on bottom of index page as link to archive)
    template_archive="Ver mais"
    # "All posts" (title of archive page)
    template_archive_title="Todas as publicações"
    # "All tags"
    ...
    template_archive_index_page="Voltar para a página inicial"
    # "Subscribe" (used on bottom of index page, it is link to RSS feed)
    template_subscribe="Inscreva-se"
    # "Subscribe to this page..." (used as text for browser feed button that is embedded to html)
    template_subscribe_browser_button="Inscreva-se nesta página..."
